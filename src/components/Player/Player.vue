...
import { Time, mArray } from '@/assets/js/utils.js'
import ProgressBar from '@/components/base/ProgressBar/ProgressBar'
import ProgressCircle from '@/components/base/ProgressCircle/ProgressCircle'
...
export default {
  ...
  methods: {
    ...
    changeMode() {
      ...
      if (mode === 2) {
        // 随机播放
        newList = mArray.shuffle(this.sequenceList)
      } else {
        // 顺序播放、单曲循环
